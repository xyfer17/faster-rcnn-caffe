...
_CUSTOMPOOLINGPARAMETER_POOLMETHOD = _descriptor.EnumDescriptor(
  name='PoolMethod',
  full_name='caffe.CustomPoolingParameter.PoolMethod',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_CUSTOMPOOLINGPARAMETER_POOLMETHOD)

_CUSTOMPOOLINGPARAMETER_ENGINE = _descriptor.EnumDescriptor(
  name='Engine',
  full_name='caffe.CustomPoolingParameter.Engine',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_CUSTOMPOOLINGPARAMETER_ENGINE)

_CUSTOMPOOLINGPARAMETER_ROUNDMODE = _descriptor.EnumDescriptor(
  name='RoundMode',
  full_name='caffe.CustomPoolingParameter.RoundMode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_CUSTOMPOOLINGPARAMETER_ROUNDMODE)
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cu_pooling_param', full_name='caffe.LayerParameter.cu_pooling_param', index=60,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rpn_param', full_name='caffe.LayerParameter.rpn_param', index=62,
...
_CUSTOMPOOLINGPARAMETER = _descriptor.Descriptor(
  name='CustomPoolingParameter',
  full_name='caffe.CustomPoolingParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pool', full_name='caffe.CustomPoolingParameter.pool', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pad', full_name='caffe.CustomPoolingParameter.pad', index=1,
      number=4, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pad_h', full_name='caffe.CustomPoolingParameter.pad_h', index=2,
      number=9, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pad_w', full_name='caffe.CustomPoolingParameter.pad_w', index=3,
      number=10, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='kernel_size', full_name='caffe.CustomPoolingParameter.kernel_size', index=4,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='kernel_h', full_name='caffe.CustomPoolingParameter.kernel_h', index=5,
      number=5, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='kernel_w', full_name='caffe.CustomPoolingParameter.kernel_w', index=6,
      number=6, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stride', full_name='caffe.CustomPoolingParameter.stride', index=7,
      number=3, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stride_h', full_name='caffe.CustomPoolingParameter.stride_h', index=8,
      number=7, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stride_w', full_name='caffe.CustomPoolingParameter.stride_w', index=9,
      number=8, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='engine', full_name='caffe.CustomPoolingParameter.engine', index=10,
      number=11, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='global_pooling', full_name='caffe.CustomPoolingParameter.global_pooling', index=11,
      number=12, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='round_mode', full_name='caffe.CustomPoolingParameter.round_mode', index=12,
      number=13, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[],
  enum_types=[
    _CUSTOMPOOLINGPARAMETER_POOLMETHOD,
    _CUSTOMPOOLINGPARAMETER_ENGINE,
    _CUSTOMPOOLINGPARAMETER_ROUNDMODE,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto2',
...
_LAYERPARAMETER.fields_by_name['cu_pooling_param'].message_type = _CUSTOMPOOLINGPARAMETER
...
_CUSTOMPOOLINGPARAMETER.fields_by_name['pool'].enum_type = _CUSTOMPOOLINGPARAMETER_POOLMETHOD
_CUSTOMPOOLINGPARAMETER.fields_by_name['engine'].enum_type = _CUSTOMPOOLINGPARAMETER_ENGINE
_CUSTOMPOOLINGPARAMETER.fields_by_name['round_mode'].enum_type = _CUSTOMPOOLINGPARAMETER_ROUNDMODE
_CUSTOMPOOLINGPARAMETER_POOLMETHOD.containing_type = _CUSTOMPOOLINGPARAMETER
_CUSTOMPOOLINGPARAMETER_ENGINE.containing_type = _CUSTOMPOOLINGPARAMETER
_CUSTOMPOOLINGPARAMETER_ROUNDMODE.containing_type = _CUSTOMPOOLINGPARAMETER
...
DESCRIPTOR.message_types_by_name['CustomPoolingParameter'] = _CUSTOMPOOLINGPARAMETER
...
CustomPoolingParameter = _reflection.GeneratedProtocolMessageType('CustomPoolingParameter', (_message.Message,), {
  'DESCRIPTOR' : _CUSTOMPOOLINGPARAMETER,
  '__module__' : 'caffe.proto.caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.CustomPoolingParameter)
  })
_sym_db.RegisterMessage(CustomPoolingParameter)
